...
const GestionClasse = () => {
  ...
  const resetEleveForm = () => {
    setEleveForm({ nom: '', prenom: '', date_naissance: '', sexe: 'M' });
                    ...
                    <form onSubmit={handleEleveSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value) => setEleveForm({ ...eleveForm, sexe: value })}
                        >
                          <SelectTrigger data-testid="select-sexe-eleve">
                            <SelectValue placeholder="Sélectionner" />
                          </SelectTrigger>
                          <SelectContent>
                            <SelectItem value="M" data-testid="option-garcon">Garçon</SelectItem>
                            <SelectItem value="F" data-testid="option-fille">Fille</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                      <div>
